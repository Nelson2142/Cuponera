...
const Oferts = ({ oferts, setVista, setCuponSeleccionado }) => {
    const handleComprar = (ofert) => {
        setCuponSeleccionado(ofert); // Guardamos el cupón seleccionado
        setVista("comprar");         // Cambiamos la vista a 'comprar'
    };
